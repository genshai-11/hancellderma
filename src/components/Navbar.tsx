...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 glass-nav shadow-sm animate-fade-up">
      <div className="flex justify-between items-center px-6 md:px-8 py-0.5 md:py-1 max-w-7xl mx-auto gap-3">
        <Link to="/" className="flex items-center text-on-surface whitespace-nowrap interactive-scale shrink-0">
          <img src={navbarLogoImg} alt="Hancell logo" className="w-16 h-16 md:w-20 md:h-20 object-contain" />
        </Link>
