            ...
            <div className="relative animate-fade-up-delay-2">
              ...
              <div className="relative z-10 rounded-[2rem] bg-white p-3 md:p-4 editorial-shadow animate-soft-float hover-lift">
                <div className="rounded-[1.5rem] overflow-hidden bg-surface-container-lowest border border-outline-variant/10 min-h-[520px] md:min-h-[640px] flex items-center justify-center">
                  <img src={heroCollectionImg} alt="Hancell skincare collection" className="w-full h-full object-contain object-center scale-[1.02] -translate-y-5 md:-translate-y-7" />
                </div>
              </div>
              <div className="absolute -bottom-16 md:-bottom-20 lg:-bottom-16 left-1/2 -translate-x-1/2 lg:left-auto lg:right-6 lg:translate-x-0 bg-white p-6 rounded-2xl editorial-shadow z-20 w-[92%] max-w-md hover-lift animate-fade-up-delay-3 border border-outline-variant/20">
